        ...
        <List>
            <ListItem button key={"User"} className={classes.buttonMain}>
              ...
              <ListItem button key={"Home"} style={{textAlign:"center",marginTop:"3rem"}}>
                  <a href="/" className={classes.buttons}>
                    <InlineIcon icon={home} />
                  </a>
                  
              </ListItem>
              <ListItem button key={"Game"} className={classes.buttonMain}>
                  <a className={classes.buttons} href="/game">
                    <InlineIcon icon={controller} />
                  </a>
              </ListItem>
              <ListItem button key={"test"} className={classes.buttonMain}>
              <a className={classes.buttons} href="/test">
                    <InlineIcon icon={createNew} />
                  </a>
              </ListItem>
              <ListItem button key={"stats"} className={classes.buttonMain}>
                  <a className={classes.buttons} href="/stats">
                    <InlineIcon icon={barChart} />
                  </a>
              </ListItem>
              <ListItem button key={"Leaderboard"} className={classes.buttonMain}>
                  <a className={classes.buttons} href="/leaderboard">
                    <InlineIcon icon={trophy} />
                  </a>
              </ListItem>
              <ListItem button key={"Config"} style={{textAlign:"center",marginTop:"4rem",position: "fixed", bottom: "0"}} href="/settings">
                  <a className={classes.buttons} href="/settings">
                    <InlineIcon icon={services} />
                  </a>
              </ListItem>
        </List>
    </div>
